...
{
    class holographicExperimentFrameworkMain : public DX::IDeviceNotify
    {
    public:
        holographicExperimentFrameworkMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~holographicExperimentFrameworkMain();
